...
namespace Leto.Interop
{
    ...
    {
        internal static readonly EVP_BulkCipher_Type EVP_aes_128_gcm = Internal_EVP_aes_128_gcm();
        internal static readonly EVP_BulkCipher_Type EVP_aes_256_gcm = Internal_EVP_aes_256_gcm();
        internal static readonly EVP_BulkCipher_Type EVP_aes_128_ccm = Internal_EVP_aes_128_ccm();
        internal static readonly EVP_BulkCipher_Type EVP_chacha20_poly1305 = Internal_EVP_chacha20_poly1305();
        ...
        internal struct EVP_BulkCipher_Type
        {
            private IntPtr _ptr;
        }
