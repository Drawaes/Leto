...
namespace Leto.Interop
{
    public static partial class LibCrypto
    {
        ...
        public static unsafe int EVP_CIPHER_CTX_SetTag(EVP_CIPHER_CTX ctx, ReadOnlySpan<byte> tag)
        {
        ...
        public static unsafe int EVP_CIPHER_CTX_GetTag(EVP_CIPHER_CTX ctx, Span<byte> tag)
        {
            fixed (void* tagPtr = &tag.DangerousGetPinnableReference())
            {
