...
namespace Leto.Tls13.BulkCipher.Windows
{
    public class AeadBulkCipherInstance : IBulkCipherInstance
    {
        ...
        public void Encrypt(ref WritableBuffer buffer, RecordType recordType)
        {
            throw new NotImplementedException();
        }

        public void EncryptWithAuthData(ref WritableBuffer buffer, RecordType recordType, ushort tlsVersion)
        {
            throw new NotImplementedException();
        }
